...
class PaymentController:
    ...
    def generate_payment_request(self, claim_id):
        ...
        return {'success': True, 'message': 'Payment request generated', 'payment_id': payment.payment_id}
    ...
    def check_payment_status(self, claim_id):
        ...
        if payment:
            ...
            return {'success': True, 'message': 'Payment status checked', 'status': payment.status}
        else:
            return {'success': False, 'message': 'Payment not found'}
